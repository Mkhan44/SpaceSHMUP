...
public class PowerUp : MonoBehaviour {
	...
	//This is an unusual but hand yuse of Vector2s. x holds a min value.
	...
	void Update () {
		...
		//Multiplying it by Time.time causes the roation to be time-based.
		cube.transform.rotation = Quaternion.Euler (rotPerSecond * Time.time);

		//Fade out the PowerUP over time.
		//Given the default values, a PowerUP will exist for 10 seconds.
		//And then fiade out over 4 seconds.
